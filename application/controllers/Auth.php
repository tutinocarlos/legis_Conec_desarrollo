...
//
//echo '<br>-->'.$user;
//echo '<br>'.$this->encryption->decrypt($user);
//echo '<br>++>'.$password;
//echo '<br>'.$this->encryption->decrypt($password);
//		
//die();
...
//			die($this->ion_auth->errors().'--<--<z'.$this->session->set_flashdata('message', $this->ion_auth->errors()));
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			// render
			 $render = $this->_render_page('auth' . DIRECTORY_SEPARATOR . 'change_password', $this->data);
//			$data = array(
//				'header' 	=> '',
//				'panel' 	=> '',
//				'content' => $render,
//				'script' 	=> base_url().'static/manager/scripts/change_password.js'
//			); 
//		 	
	...
	public function forgot_password()
	{
		...
		else
		{
			...
			$identity_column = $this->config->item('identity', 'ion_auth');
		 	...
		 	$identity = $this->ion_auth->where('users.email', $this->input->post('identity'))->users()->row();
