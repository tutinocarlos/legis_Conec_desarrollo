...
define('ADM_ROOT', 'lcaba_admin/');
define('SRV_ROOT', $srvRoot);
define('WEB_WS', WEB_ROOT.'_ws.php'); //armar en el htacces un modelo para enviar con parametros
define('SMTP_MAIL','dirivero@legislatura.gov.ar');
define('SMTP_PASS','D3loused');
define('SMTP_IP','10.1.1.62');
define('RECAPTCHA_SECRET', '6LevP2oUAAAAACWsgqBNZsm5pwO6KiNZ3BKvx1xT');
define('RECAPTCHA_CLAVE','6LevP2oUAAAAAG2m2jLMfakkjZij_AjC-ad_JzhW');
define('RECAPTCHA_URL','https://www.google.com/recaptcha/api/siteverify');
define('USUARIOS', 'http://usuarios.legislatura.gov.ar');
 */
...
$config['smtp_host'] = 'smtp.carlostutino.com';
$config['smtp_user'] = 'cat@carlostutino.com'; // correo sin espacio
$config['smtp_pass'] = 'Barbara2020';
$config['email_from_name'] = 'chorecjh';


$config['email_smtp'] = TRUE;
//$config['email_from'] = 'smtp.gmail.com';
//$config['email_from'] = 'ssl://smtp.gmail.com';
$config['admin_email'] = 'cat@carlostutino.com';
...
//			$config['smtp_user'] = 'no-reply@mysetup.com.ar'; // correo sin espacio
//			$config['smtp_pass'] = 'jif7j2019';
...
//    $config['protocol'] = "smtp";
//    $config['smtp_host'] = 'no-reply@mysetup.com.ar';
//    $config['smtp_port'] = '465';
//    $config['smtp_timeout'] = '5';
//    $config['smtp_user'] = 'mail.mysetup.com.ar';
//    $config['smtp_pass'] = 'jif7j2019';
//}
...
$config['tables']['legislaturas']			= 'legislaturas';
...
$config['join']['legislaturas'] = 'legislatura_id';
 ...
 */
$config['site_title']                 = "Legislaturas Conectadas";       // Site Title, example.com
$config['admin_email']                = "cat@carlostutino.com"; // Admin Email, admin@example.com
...
$config['reset_pwd'] = 'reset.tpl.php';
