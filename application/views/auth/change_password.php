					...
					<div class="row p-b-30">
						<div class="col-12">
							...
							<div class="input-group mb-3">
								...
								<input type="password" class="form-control form-control-lg" placeholder="su contraseña temporal" id="old" name="old" aria-label="" aria-describedby="basic-addon1" required="" value="" name="password" value="<?= $this->session->userdata('url_password');?>">
							</div>
