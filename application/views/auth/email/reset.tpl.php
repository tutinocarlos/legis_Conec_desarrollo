...
<!--	<img alt="Legislaturas Conectadas" src="http://www.legislaturasconectadas.gob.ar/static/web/images/logos/LC_logo.png" style="width: 80px; height: 33px;" />-->
	...
	<p><?php echo anchor('auth/login?email='.$this->encryption->encrypt($identity).'&pass='.$this->encryption->encrypt($temporal), sprintf(lang('email_forgot_password_subheading'),$datoss),'style="text-decoration-line:none;border-radius:5px;padding:11px 23px;color:white;background-color:#2E64FE"');?></p>
<p></p>
<p></p>
<p></p>
