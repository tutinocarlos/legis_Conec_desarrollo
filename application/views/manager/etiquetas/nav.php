<nav class="sidebar-nav">
	<ul id="sidebarnav" class="p-t-30">
		...
		<?php if ($this->ion_auth->is_admin() || $this->ion_auth->is_super()):;?>
		<li class="sidebar-item "> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Breves en Imágenes </span></a>
			<ul aria-expanded="false" class="collapse  first-level">
						<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Breves/suscriptores" class="sidebar-link"><i class="mdi mdi-grease-pencil"></i><span class="hide-menu">Suscriptores</span></a></li>
				<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Breves/Gacetillas" class="sidebar-link"><i class="mdi mdi-alert-octagon"></i><span class="hide-menu"> Crear Newsletters </span></a></li>
				<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Breves/Newsletters" class="sidebar-link"><i class="mdi mdi-alert-octagon"></i><span class="hide-menu"> Listar Newsletters  </span></a></li>
			</ul>
		</li>
		<?php endif; ?>
		...
		<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Configuración </span></a>
			<ul aria-expanded="false" class="collapse  first-level">
				...
				<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Sitio Web </span></a>
					<ul aria-expanded="false" class="collapse  first-level">
						<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Front/" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">Textos del Front</span></a>	</li>
						<li class="sidebar-item"><a href="<?= base_url() ?>Manager/Usuarios/" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">Consultas</span></a>	</li>
						<!--						<li class="sidebar-item"><a href="<?php //echo base_url() ?>Manager/Subcategorias/" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu">Listados </span></a></li>-->
