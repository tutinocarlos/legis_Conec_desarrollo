...
<div class="card-body">
	...
	<div class="row">
		...
		<div class="form-group col-md-1">
			<label>ZONA </label>
			<input type="text" class="form-control purchase-inputmask" name="detalle" value="<?= $provincia->zona?> " readonly>
		</div>
		...
		<div class="form-group col-md-2">
			<label for="position-bottom-left">Color identificator de Provincia</label>
		...
		<div class="form-group col-md-3">
			<label for="position-bottom-left">Color Identificador de Tipo Cámara</label>
	...
	//						'required'    => 	'required'
		...
		<div class="form-group col-md-6 ">
			...
			<textarea rows="4" cols="50" name="comentario"><?= $provincia->comentario?> </textarea>
		</div>
