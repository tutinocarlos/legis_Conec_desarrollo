<div class="col-md-6" data-select2-id="15">
	<div class="card">
		...
		$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
			echo form_open('Manager/Categorias/grabar_categorias',$attributes);
		?>
<!--		<form class="form-horizontal" action="/Manager/Contenidos/grabar_categorias" method="post">-->
			<div class="card-body">
				<h4 class="card-title">Nueva Temática</h4>
				<div class="form-group row">
				
<!--					<label for="fname" class="col-sm-3 text-right control-label col-form-label">Nombre</label>-->
					<?php
						$data = array(
							'class' => 'col-sm-3 text-right control-label col-form-label dataTables_filter',
						);
...
<!--						<input type="text" class="form-control" name="detalle" placeholder="Last Name Here">-->
					<?php
						...
						echo form_error('detalle','	<div class="invalid-feedback" style="display:block;">',"</div>");
					?>
					</div>
				</div>				
					...
					<table id="example" class="display" style="width:100%">
						<thead>
							<tr>
								...
								<th class="" style="text-align: right;">Acciones</th>
							</tr>
						</thead>
						<tfoot>
							<tr>
