...
<div id="accordian-4" class="col col-md-12">
	<div class="card m-t-30 edit_post">
		<a class="card-header link" data-toggle="collapse" data-parent="#accordian-4" href="#Toggle-1" aria-expanded="true" aria-controls="Toggle-1">
			...
			<span class="titulos_accordian">Editar Textos </span><?= $this->fecha_now;?>
		</a>
						...
						<div class="tab-content tabcontent-border">
							<div class="tab-pane active" id="home" role="tabpanel">
								<div class="p-20">
									<div class="card">
										<div class="card-body">
											<input type="text" id="id_post" name="id_post" value="<?php echo $post->id ?>" readonly>
											<input type="text" id="id_user_login" name="id_user_login" value="<?php echo $post->id_usuario ?>" readonly>
